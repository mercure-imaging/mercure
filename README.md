...
**Important:** mercure (formerly called Hermes) is still undergoing significant development work towards a stable release version 0.2. <style type="text/css">p {color:red;}</style>**Parts of the source code are still incomplete and untested.** Use at your own risk.
